...
from formatters.models import (BookModel, InternetResourceModel, ArticlesCollectionModel,
                               DissertationModel, MagazineArticleModel, NewspaperArticleModel)
from readers.reader import (
    BookReader,
    SourcesReader,
    InternetResourceReader,
    ArticlesCollectionReader,
    DissertationReader,MagazineArticleReader,NewspaperArticleReader
)
...
class TestReaders:
    ...
    def test_newspaper_articles(self, workbook: Any) -> None:
        """
    ...
    def test_magazine_articles(self, workbook: Any) -> None:
        """
    ...
    def test_dissertation(self, workbook: Any) -> None:
        ...
        assert model.title == "Наука как искусство"
        assert model.dr_or_ph == "д-р. / канд."
